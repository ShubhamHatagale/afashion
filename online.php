                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" checked data-toggle="toggle" data-on="Activated" data-off="Deactivated" data-onstyle="success" data-offstyle="danger">
                                                    </td>
                                                    <td>
                                                        <center> <a href="online_product.php?Mainid=<?php echo $varid; ?>&MainQty=<?php echo $qty; ?>" class="btn btn-success">Online Product</a></center>
                                                    </td>
