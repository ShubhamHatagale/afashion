        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-3">
                            <span class="m-0 text-dark m-1"><b>Add Sub-Category</b></span>
                        </div><!-- /.col -->
                        <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-md-3 ml-3">
                                <div class="form-group">
                                    <label for="exampleInputPassword2" class="control-label">Sub-Category Name:</label>
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="subcate" placeholder="Enter subcate name" required onchange="chkVal()">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title"><b>Sub-Category Register</b></h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $selectquery = "select * from sub_categories";
