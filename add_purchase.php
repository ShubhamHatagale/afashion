    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-3">
                        <span class="m-0 text-dark m-1"><b>Material Purchase</b></span>
                    </div><!-- /.col -->
                    <div class="col-sm-9">
                            ...
                            <div class="card form-row">
                                ...
                                <div class="card-body form-row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="name" class="form-control" id="fid" name="fid" list="dataListId" placeholder="Search for firms.." title="Type in a name">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="name" class="form-control" id="sid" name="suppliers" list="dataListIdSid" placeholder="Search for suppliers.." title="Type in a name">
                                        <datalist id="dataListIdSid">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#modelAdd").click(function() {
                ...
                if (prod_qty >= counts && prod_qty >= cnts && prod_qty >= qtysum && qty != 0) {
                    for (let a = 1; a <= 1; a++) {
        ...
        function clearData() {
            let prod_qtys = parseInt(document.getElementById("prod_qty").value);

            var tds = document.getElementById('modelTbody').getElementsByTagName('td');
            var sum = 0;
            ...
            document.getElementById('modelTbody').innerHTML;
            alert(sum);
            if (prod_qtys !== sum) {
                alert("Add all the required variation");
                setTimeout(function() {
                    $('#modelAdd').focus();
                }, 5000);
