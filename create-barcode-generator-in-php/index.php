...
include('header.php');
?>
<title>phpzag.com : Demo Create Barcode Generator in PHP</title>
<style>
img.barcode {
...
<div class="container">
	...
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="http://www.phpzag.com/create-barcode-generator-in-php/">Back to Tutorial</a>		
	</div>
</div>
