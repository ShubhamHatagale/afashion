...
<head>
    <title>Transfered Stock Register</title>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1 class="m-0 text-dark">Transfered Stock Register</h1>
                        <?php
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title"><b>Sales Reister</b></h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $selectquery = "select * from stock_transfer_products";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $res['from_firm']; ?></td>
                                                        <td><?php echo $res['date_time']; ?></td>
                                                        <td><?php echo $res['to_firm']; ?></td>
